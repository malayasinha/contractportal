						...
						<table class="bank">
							...
							<tr>
								...
								<td><form:input path="lName" style="width: 116px"
										validate="Last Name,string,yes" /></td>
							</tr>
							...
							<tr>
								...
								<td><form:input path="dName" style="width: 116px"
										validate="Display Name,string,yes" /></td>

								<td><form:label path="username">
										<spring:message code="label.username" />
									</form:label></td>
								<td><form:input path="username" style="width: 116px"
										validate="User Name,string,yes" /></td>
							...
							<tr>
								...
								<td><select name="employeeId" style="width: 122px;"
							...
							<tr>
								...
								<td><select name="roleId" style="width: 122px;"
									validate="Role,string,yes">
										<option value="">---Select---</option>
				...
				<div>
					<div class="box1_con_blue">
						<input class="press" type="button"
							...
							class="press" type="button" id="update"
							onclick="submitForm('User', '/tatasky/addUser/${usersEntity.id}');"
