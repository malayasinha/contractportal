...
@ComponentScan(basePackages = { "com.sspl" })
public class HibernateConfig {
	...
	/*
	 * @Bean public NamedParameterJdbcTemplate jdbcTemplate(DataSource
	 * dataSource) { NamedParameterJdbcTemplate jdbcTemplate = new
	...
	public LocalSessionFactoryBean sessionFactory() {
		...
		sessionFactory.setPackagesToScan(new String[] { "com.sspl.entity" });
	 ...
	 * entityManagerFactoryBean.setPackagesToScan("com.sspl.entity");
